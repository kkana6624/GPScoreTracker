...
public class PersonalHighScoreTests
{
    ...
    public void Constructor_ValidParameters_CreatesInstance()
    {
        ...
        Assert.Equal(chartId, personalHighScore.ChartId);
    ...
    public void TryUpdateWith_HigherScore_UpdatesAndReturnsTrue()
    {
        ...
        var personalHighScore = new PersonalHighScore(
            ...
            Guid.NewGuid(),
            Guid.NewGuid(),
            CreateTestScore(900000), // 現在のスコア: 900,000
    ...
    public void Equals_SameId_ReturnsTrue()
    {
        ...
        var personalHighScore1 = new PersonalHighScore(
            id, Guid.NewGuid(), Guid.NewGuid(), CreateTestScore(), DateTime.UtcNow);
    ...
    public void Equals_DifferentId_ReturnsFalse()
    {
        // Arrange
        var personalHighScore1 = new PersonalHighScore(
            Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), CreateTestScore(), DateTime.UtcNow);
        var personalHighScore2 = new PersonalHighScore(
            Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), CreateTestScore(), DateTime.UtcNow);
...
#pragma warning restore CS1718
    ...
    public void ToString_ReturnsFormattedString()
    {
        ...
        var personalHighScore = new PersonalHighScore(
            id, userId, chartId, CreateTestScore(980000), achievedAt);
        ...
        Assert.Contains(chartId.ToString(), result);
